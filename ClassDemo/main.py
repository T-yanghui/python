...
def UID_Create():
	return random_str(20) + "baidu.com"
...
def CreateTime():
	...
	# DONE_EventUID = random_str(20) + "&baidu..com"
...
def uniteSetting():
	...
	DONE_ALARMUID = random_str(30) + "&baidu."
	# 
	global DONE_UnitUID
	DONE_UnitUID = random_str(20) + "&baidu.com"
	print("uniteSetting")

def setClassTime():
	data = []
	with open('D:/code/python/ClassDemo/conf_classTime.json', 'r',encoding='utf-8') as f:
		data = json.load(f)
...
def setClassInfo():
	data = []
	with open('D:/code/python/ClassDemo/conf_classInfo.json', 'r') as f:
		data = json.load(f)
	global classInfoList
